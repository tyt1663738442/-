...
_SINA_SECTOR_INDEX_MAP = {
    ...
    '房地产开发': 's_sh000952',# 300地产
    '地产': 's_sh000952',      # 300地产
    # 工业制造
    '建筑': 's_sh000034',      # 上证工业
    '建筑行业': 's_sh000034',  # 上证工业
    '钢铁': 's_sh000034',      # 上证工业
    '钢铁行业': 's_sh000034',  # 上证工业
    '机械设备': 's_sh000034',  # 上证工业
    '专用设备': 's_sh000034',  # 上证工业
    '通用机械': 's_sh000034',  # 上证工业
    '仪器仪表': 's_sh000034',  # 上证工业
    '航天航空': 's_sh000034',  # 上证工业
    '飞机制造': 's_sh000034',  # 上证工业
    '船舶制造': 's_sh000034',  # 上证工业
    '机器人': 's_sh000034',    # 上证工业
    '工业机器人': 's_sh000034',# 上证工业
    '工业互联网': 's_sh000034',# 上证工业
    '交通运输': 's_sh000034',  # 上证工业
    '公路桥梁': 's_sh000034',  # 上证工业
    '物流行业': 's_sh000034',  # 上证工业
    '发电设备': 's_sh000034',  # 上证工业
    '电网设备': 's_sh000041',  # 上证公用
    '工程机械': 's_sh000034',  # 上证工业
    # 能源
    '煤炭': 's_sh000032',      # 上证能源
    '煤炭行业': 's_sh000032',  # 上证能源
    '石油': 's_sh000032',      # 上证能源
    '石油行业': 's_sh000032',  # 上证能源
    '电力': 's_sh000041',      # 上证公用
    '电力行业': 's_sh000041',  # 上证公用
    '新能源': 's_sh000032',    # 上证能源
    '风能': 's_sh000032',      # 上证能源
    '核能核电': 's_sh000032',  # 上证能源
    # 公用事业
    '环保行业': 's_sh000041',  # 上证公用
    '环境保护': 's_sh000041',  # 上证公用
    '水务': 's_sh000041',      # 上证公用
    '供水供气': 's_sh000041',  # 上证公用
    '燃气': 's_sh000041',      # 上证公用
    '储能': 's_sh000041',      # 上证公用
    # 材料
    '化工': 's_sh000033',      # 上证材料
    '化工行业': 's_sh000033',  # 上证材料
    '化纤行业': 's_sh000033',  # 上证材料
    '化学制品': 's_sh000033',  # 上证材料
    '化学原料': 's_sh000033',  # 上证材料
    '塑料制品': 's_sh000033',  # 上证材料
    '橡胶制品': 's_sh000033',  # 上证材料
    '玻璃行业': 's_sh000033',  # 上证材料
    '水泥建材': 's_sh000033',  # 上证材料
    '建材': 's_sh000033',      # 上证材料
    '有色金属': 's_sh000033',  # 上证材料
    '小金属': 's_sh000033',    # 上证材料
    '能源金属': 's_sh000033',  # 上证材料
    ...
    '医药商业': 's_sh000933',  # 中证医药
    '医疗器械': 's_sh000933',  # 中证医药
    '医疗服务': 's_sh000933',  # 中证医药
    '生物制品': 's_sh000933',  # 中证医药
    '化学制药': 's_sh000933',  # 中证医药
    '中药': 's_sh000933',      # 中证医药
    '创新药': 's_sh000933',    # 中证医药
    # 消费
    ...
    '白酒': 's_sh000932',      # 中证消费
    '啤酒': 's_sh000932',      # 中证消费
    '农牧饲渔': 's_sh000932',  # 中证消费
    '农林牧渔': 's_sh000932',  # 中证消费
    '旅游酒店': 's_sh000932',  # 中证消费
    '酒店旅游': 's_sh000932',  # 中证消费
    '景点旅游': 's_sh000932',  # 中证消费
    '餐饮': 's_sh000932',      # 中证消费
    '预制菜': 's_sh000932',    # 中证消费
    '家电行业': 's_sh000035',  # 上证可选
    '家用电器': 's_sh000035',  # 上证可选
    '汽车整车': 's_sh000035',  # 上证可选
    '汽车零部件': 's_sh000035',# 上证可选
    '汽车服务': 's_sh000035',  # 上证可选
    '纺织服装': 's_sh000035',  # 上证可选
    '纺织行业': 's_sh000035',  # 上证可选
    '纺织机械': 's_sh000035',  # 上证可选
    '服装鞋类': 's_sh000035',  # 上证可选
    '商业百货': 's_sh000035',  # 上证可选
    '零售': 's_sh000035',      # 上证可选
    '免税概念': 's_sh000035',  # 上证可选
    '家具行业': 's_sh000035',  # 上证可选
    '装修建材': 's_sh000035',  # 上证可选
    '装修装饰': 's_sh000035',  # 上证可选
    '家用轻工': 's_sh000035',  # 上证可选
    '造纸印刷': 's_sh000035',  # 上证可选
    '美容护理': 's_sh000035',  # 上证可选
    # TMT
    '电子元件': 's_sh000935',  # 中证信息
    '电子化学品': 's_sh000935',# 中证信息
    '半导体': 's_sh000935',    # 中证信息
    '芯片': 's_sh000935',      # 中证信息
    '集成电路': 's_sh000935',  # 中证信息
    '计算机设备': 's_sh000935',# 中证信息
    '软件开发': 's_sh000935',  # 中证信息
    'IT服务': 's_sh000935',    # 中证信息
    '通信设备': 's_sh000040',  # 上证电信
    '通信服务': 's_sh000040',  # 上证电信
    '文化传媒': 's_sh000935',  # 中证信息
    '游戏': 's_sh000935',      # 中证信息
    '互联网服务': 's_sh000935',# 中证信息
    '人工智能': 's_sh000935',  # 中证信息
    '算力概念': 's_sh000935',  # 中证信息
    '东数西算': 's_sh000935',  # 中证信息
    '数据中心': 's_sh000935',  # 中证信息
    '云计算': 's_sh000935',    # 中证信息
    '大数据': 's_sh000935',    # 中证信息
    '5G概念': 's_sh000040',    # 上证电信
    '6G概念': 's_sh000040',    # 上证电信
    '区块链': 's_sh000935',    # 中证信息
    '数字货币': 's_sh000935',  # 中证信息
    '物联网': 's_sh000040',    # 上证电信
    '车联网': 's_sh000040',    # 上证电信
    '网络安全': 's_sh000935',  # 中证信息
    '信创': 's_sh000935',      # 中证信息
    '国产软件': 's_sh000935',  # 中证信息
    '元宇宙': 's_sh000935',    # 中证信息
    '虚拟现实': 's_sh000935',  # 中证信息
    '消费电子': 's_sh000935',  # 中证信息
    '光学光电子': 's_sh000935',# 中证信息
    'LED': 's_sh000935',       # 中证信息
    '面板': 's_sh000935',      # 中证信息
    '教育': 's_sh000935',      # 中证信息
}
